...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this input-otp component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this input-otp component variant."),
  ...
  }).partial().describe("Additional metadata for the input-otp component variant."),
});
...
export const HERO_COMP_INPUT_OTP_01: Tool = {
  id: "HERO_COMP_INPUT_OTP_01",
  name: "Define Input OTP Component Variant",
  description: "Defines and stores a new input-otp component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "input-otp",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
