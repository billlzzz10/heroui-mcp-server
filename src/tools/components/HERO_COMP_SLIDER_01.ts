...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this slider component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this slider component variant."),
  ...
  }).partial().describe("Additional metadata for the slider component variant."),
});
...
export const HERO_COMP_SLIDER_01: Tool = {
  id: "HERO_COMP_SLIDER_01",
  name: "Define Slider Component Variant",
  description: "Defines and stores a new slider component variant based on provided specifications.",
