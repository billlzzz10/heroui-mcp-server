...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this drawer component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this drawer component variant."),
  ...
  }).partial().describe("Additional metadata for the drawer component variant."),
});
...
export const HERO_COMP_DRAWER_01: Tool = {
  id: "HERO_COMP_DRAWER_01",
  name: "Define Drawer Component Variant",
  description: "Defines and stores a new drawer component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "drawer",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
