...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this autocomplete component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this autocomplete component variant."),
  ...
  }).partial().describe("Additional metadata for the autocomplete component variant."),
});
...
export const HERO_COMP_AUTOCOMPLETE_01: Tool = {
  id: "HERO_COMP_AUTOCOMPLETE_01",
  name: "Define Autocomplete Component Variant",
  description: "Defines and stores a new autocomplete component variant based on provided specifications.",
