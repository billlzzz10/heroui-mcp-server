...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this navbar component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this navbar component variant."),
  ...
  }).partial().describe("Additional metadata for the navbar component variant."),
});
...
export const HERO_COMP_NAVBAR_01: Tool = {
  id: "HERO_COMP_NAVBAR_01",
  name: "Define Navbar Component Variant",
  description: "Defines and stores a new navbar component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "navbar",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
