...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this link component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this link component variant."),
  ...
  }).partial().describe("Additional metadata for the link component variant."),
});
...
export const HERO_COMP_LINK_01: Tool = {
  id: "HERO_COMP_LINK_01",
  name: "Define Link Component Variant",
  description: "Defines and stores a new link component variant based on provided specifications.",
