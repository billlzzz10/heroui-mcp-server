...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this divider component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this divider component variant."),
  ...
  }).partial().describe("Additional metadata for the divider component variant."),
});
...
export const HERO_COMP_DIVIDER_01: Tool = {
  id: "HERO_COMP_DIVIDER_01",
  name: "Define Divider Component Variant",
  description: "Defines and stores a new divider component variant based on provided specifications.",
