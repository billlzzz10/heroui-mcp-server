...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this popover component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this popover component variant."),
  ...
  }).partial().describe("Additional metadata for the popover component variant."),
});
...
export const HERO_COMP_POPOVER_01: Tool = {
  id: "HERO_COMP_POPOVER_01",
  name: "Define Popover Component Variant",
  description: "Defines and stores a new popover component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "popover",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
