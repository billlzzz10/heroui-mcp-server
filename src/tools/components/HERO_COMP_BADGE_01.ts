...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this badge component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this badge component variant."),
  ...
  }).partial().describe("Additional metadata for the badge component variant."),
});
...
export const HERO_COMP_BADGE_01: Tool = {
  id: "HERO_COMP_BADGE_01",
  name: "Define Badge Component Variant",
  description: "Defines and stores a new badge component variant based on provided specifications.",
