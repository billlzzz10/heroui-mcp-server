...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this listbox component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this listbox component variant."),
  ...
  }).partial().describe("Additional metadata for the listbox component variant."),
});
...
export const HERO_COMP_LISTBOX_01: Tool = {
  id: "HERO_COMP_LISTBOX_01",
  name: "Define Listbox Component Variant",
  description: "Defines and stores a new listbox component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "listbox",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
