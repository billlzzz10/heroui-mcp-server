...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this code component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this code component variant."),
  ...
  }).partial().describe("Additional metadata for the code component variant."),
});
...
export const HERO_COMP_CODE_01: Tool = {
  id: "HERO_COMP_CODE_01",
  name: "Define Code Component Variant",
  description: "Defines and stores a new code component variant based on provided specifications.",
