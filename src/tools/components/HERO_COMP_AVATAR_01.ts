...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this avatar component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this avatar component variant."),
  ...
  }).partial().describe("Additional metadata for the avatar component variant."),
});
...
export const HERO_COMP_AVATAR_01: Tool = {
  id: "HERO_COMP_AVATAR_01",
  name: "Define Avatar Component Variant",
  description: "Defines and stores a new avatar component variant based on provided specifications.",
