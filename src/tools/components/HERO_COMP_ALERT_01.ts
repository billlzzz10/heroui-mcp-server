...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this alert component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this alert component variant."),
  ...
  }).partial().describe("Additional metadata for the alert component variant."),
});
...
export const HERO_COMP_ALERT_01: Tool = {
  id: "HERO_COMP_ALERT_01",
  name: "Define Alert Component Variant",
  description: "Defines and stores a new alert component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "alert",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
