...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this spinner component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this spinner component variant."),
  ...
  }).partial().describe("Additional metadata for the spinner component variant."),
});
...
export const HERO_COMP_SPINNER_01: Tool = {
  id: "HERO_COMP_SPINNER_01",
  name: "Define Spinner Component Variant",
  description: "Defines and stores a new spinner component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "spinner",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
