...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this calendar component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this calendar component variant."),
  ...
  }).partial().describe("Additional metadata for the calendar component variant."),
});
...
export const HERO_COMP_CALENDAR_01: Tool = {
  id: "HERO_COMP_CALENDAR_01",
  name: "Define Calendar Component Variant",
  description: "Defines and stores a new calendar component variant based on provided specifications.",
