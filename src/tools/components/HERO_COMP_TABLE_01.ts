...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this table component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this table component variant."),
  ...
  }).partial().describe("Additional metadata for the table component variant."),
});
...
export const HERO_COMP_TABLE_01: Tool = {
  id: "HERO_COMP_TABLE_01",
  name: "Define Table Component Variant",
  description: "Defines and stores a new table component variant based on provided specifications.",
