...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this modal component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this modal component variant."),
  ...
  }).partial().describe("Additional metadata for the modal component variant."),
});
...
export const HERO_COMP_MODAL_01: Tool = {
  id: "HERO_COMP_MODAL_01",
  name: "Define Modal Component Variant",
  description: "Defines and stores a new modal component variant based on provided specifications.",
