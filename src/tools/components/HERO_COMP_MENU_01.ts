...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this menu component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this menu component variant."),
  ...
  }).partial().describe("Additional metadata for the menu component variant."),
});
...
export const HERO_COMP_MENU_01: Tool = {
  id: "HERO_COMP_MENU_01",
  name: "Define Menu Component Variant",
  description: "Defines and stores a new menu component variant based on provided specifications.",
