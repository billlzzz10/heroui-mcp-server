...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this button component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this button component variant."),
  ...
  }).partial().describe("Additional metadata for the button component variant."),
});
...
export const HERO_COMP_BUTTON_01: Tool = {
  id: "HERO_COMP_BUTTON_01",
  name: "Define Button Component Variant",
  description: "Defines and stores a new button component variant based on provided specifications.",
