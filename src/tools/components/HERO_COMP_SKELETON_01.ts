...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this skeleton component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this skeleton component variant."),
  ...
  }).partial().describe("Additional metadata for the skeleton component variant."),
});
...
export const HERO_COMP_SKELETON_01: Tool = {
  id: "HERO_COMP_SKELETON_01",
  name: "Define Skeleton Component Variant",
  description: "Defines and stores a new skeleton component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "skeleton",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
