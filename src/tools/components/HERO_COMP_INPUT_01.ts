...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this input component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this input component variant."),
  ...
  }).partial().describe("Additional metadata for the input component variant."),
});
...
export const HERO_COMP_INPUT_01: Tool = {
  id: "HERO_COMP_INPUT_01",
  name: "Define Input Component Variant",
  description: "Defines and stores a new input component variant based on provided specifications.",
