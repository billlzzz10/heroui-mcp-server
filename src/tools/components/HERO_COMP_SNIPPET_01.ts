...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this snippet component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this snippet component variant."),
  ...
  }).partial().describe("Additional metadata for the snippet component variant."),
});
...
export const HERO_COMP_SNIPPET_01: Tool = {
  id: "HERO_COMP_SNIPPET_01",
  name: "Define Snippet Component Variant",
  description: "Defines and stores a new snippet component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "snippet",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
