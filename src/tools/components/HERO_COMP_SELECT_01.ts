...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this select component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this select component variant."),
  ...
  }).partial().describe("Additional metadata for the select component variant."),
});
...
export const HERO_COMP_SELECT_01: Tool = {
  id: "HERO_COMP_SELECT_01",
  name: "Define Select Component Variant",
  description: "Defines and stores a new select component variant based on provided specifications.",
