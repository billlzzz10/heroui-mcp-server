...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this image component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this image component variant."),
  ...
  }).partial().describe("Additional metadata for the image component variant."),
});
...
export const HERO_COMP_IMAGE_01: Tool = {
  id: "HERO_COMP_IMAGE_01",
  name: "Define Image Component Variant",
  description: "Defines and stores a new image component variant based on provided specifications.",
