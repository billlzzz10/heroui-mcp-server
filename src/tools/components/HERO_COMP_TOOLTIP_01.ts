...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this tooltip component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this tooltip component variant."),
  ...
  }).partial().describe("Additional metadata for the tooltip component variant."),
});
...
export const HERO_COMP_TOOLTIP_01: Tool = {
  id: "HERO_COMP_TOOLTIP_01",
  name: "Define Tooltip Component Variant",
  description: "Defines and stores a new tooltip component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "tooltip",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
