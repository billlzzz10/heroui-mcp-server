...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this spacer component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this spacer component variant."),
  ...
  }).partial().describe("Additional metadata for the spacer component variant."),
});
...
export const HERO_COMP_SPACER_01: Tool = {
  id: "HERO_COMP_SPACER_01",
  name: "Define Spacer Component Variant",
  description: "Defines and stores a new spacer component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "spacer",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
