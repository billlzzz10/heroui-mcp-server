...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this breadcrumbs component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this breadcrumbs component variant."),
  ...
  }).partial().describe("Additional metadata for the breadcrumbs component variant."),
});
...
export const HERO_COMP_BREADCRUMBS_01: Tool = {
  id: "HERO_COMP_BREADCRUMBS_01",
  name: "Define Breadcrumbs Component Variant",
  description: "Defines and stores a new breadcrumbs component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "breadcrumbs",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
