...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this toast component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this toast component variant."),
  ...
  }).partial().describe("Additional metadata for the toast component variant."),
});
...
export const HERO_COMP_TOAST_01: Tool = {
  id: "HERO_COMP_TOAST_01",
  name: "Define Toast Component Variant",
  description: "Defines and stores a new toast component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "toast",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
