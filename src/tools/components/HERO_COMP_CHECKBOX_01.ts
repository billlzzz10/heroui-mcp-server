...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this checkbox component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this checkbox component variant."),
  ...
  }).partial().describe("Additional metadata for the checkbox component variant."),
});
...
export const HERO_COMP_CHECKBOX_01: Tool = {
  id: "HERO_COMP_CHECKBOX_01",
  name: "Define Checkbox Component Variant",
  description: "Defines and stores a new checkbox component variant based on provided specifications.",
