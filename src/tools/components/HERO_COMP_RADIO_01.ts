...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this radio component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this radio component variant."),
  ...
  }).partial().describe("Additional metadata for the radio component variant."),
});
...
export const HERO_COMP_RADIO_01: Tool = {
  id: "HERO_COMP_RADIO_01",
  name: "Define Radio Component Variant",
  description: "Defines and stores a new radio component variant based on provided specifications.",
