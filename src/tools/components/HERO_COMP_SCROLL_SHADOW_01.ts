...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this scroll-shadow component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this scroll-shadow component variant."),
  ...
  }).partial().describe("Additional metadata for the scroll-shadow component variant."),
});
...
export const HERO_COMP_SCROLL_SHADOW_01: Tool = {
  id: "HERO_COMP_SCROLL_SHADOW_01",
  name: "Define Scroll Shadow Component Variant",
  description: "Defines and stores a new scroll-shadow component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "scroll-shadow",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
