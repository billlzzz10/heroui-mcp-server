...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this ripple component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this ripple component variant."),
  ...
  }).partial().describe("Additional metadata for the ripple component variant."),
});
...
export const HERO_COMP_RIPPLE_01: Tool = {
  id: "HERO_COMP_RIPPLE_01",
  name: "Define Ripple Component Variant",
  description: "Defines and stores a new ripple component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "ripple",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
