...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this switch component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this switch component variant."),
  ...
  }).partial().describe("Additional metadata for the switch component variant."),
});
...
export const HERO_COMP_SWITCH_01: Tool = {
  id: "HERO_COMP_SWITCH_01",
  name: "Define Switch Component Variant",
  description: "Defines and stores a new switch component variant based on provided specifications.",
