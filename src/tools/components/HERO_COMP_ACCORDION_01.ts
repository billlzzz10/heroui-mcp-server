...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this accordion component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this accordion component variant."),
  ...
  }).partial().describe("Additional metadata for the accordion component variant."),
});
...
export const HERO_COMP_ACCORDION_01: Tool = {
  id: "HERO_COMP_ACCORDION_01",
  name: "Define Accordion Component Variant",
  description: "Defines and stores a new accordion component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "accordion",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
