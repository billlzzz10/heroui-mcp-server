...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this date-input component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this date-input component variant."),
  ...
  }).partial().describe("Additional metadata for the date-input component variant."),
});
...
export const HERO_COMP_DATE_INPUT_01: Tool = {
  id: "HERO_COMP_DATE_INPUT_01",
  name: "Define Date Input Component Variant",
  description: "Defines and stores a new date-input component variant based on provided specifications.",
  inputSchema: inputSchema,
  outputSchema: outputSchema,
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      objectType: "component_variant",
      targetComponent: "date-input",
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
