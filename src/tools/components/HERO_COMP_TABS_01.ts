...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this tabs component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this tabs component variant."),
  ...
  }).partial().describe("Additional metadata for the tabs component variant."),
});
...
export const HERO_COMP_TABS_01: Tool = {
  id: "HERO_COMP_TABS_01",
  name: "Define Tabs Component Variant",
  description: "Defines and stores a new tabs component variant based on provided specifications.",
