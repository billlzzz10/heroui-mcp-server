...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this chip component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this chip component variant."),
  ...
  }).partial().describe("Additional metadata for the chip component variant."),
});
...
export const HERO_COMP_CHIP_01: Tool = {
  id: "HERO_COMP_CHIP_01",
  name: "Define Chip Component Variant",
  description: "Defines and stores a new chip component variant based on provided specifications.",
