...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this progress component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this progress component variant."),
  ...
  }).partial().describe("Additional metadata for the progress component variant."),
});
...
export const HERO_COMP_PROGRESS_01: Tool = {
  id: "HERO_COMP_PROGRESS_01",
  name: "Define Progress Component Variant",
  description: "Defines and stores a new progress component variant based on provided specifications.",
