...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this form component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this form component variant."),
  ...
  }).partial().describe("Additional metadata for the form component variant."),
});
...
export const HERO_COMP_FORM_01: Tool = {
  id: "HERO_COMP_FORM_01",
  name: "Define Form Component Variant",
  description: "Defines and stores a new form component variant based on provided specifications.",
