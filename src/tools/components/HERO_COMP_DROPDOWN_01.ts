...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this dropdown component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this dropdown component variant."),
  ...
  }).partial().describe("Additional metadata for the dropdown component variant."),
});
...
export const HERO_COMP_DROPDOWN_01: Tool = {
  id: "HERO_COMP_DROPDOWN_01",
  name: "Define Dropdown Component Variant",
  description: "Defines and stores a new dropdown component variant based on provided specifications.",
