...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this kbd component variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this kbd component variant."),
  ...
  }).partial().describe("Additional metadata for the kbd component variant."),
});
...
export const HERO_COMP_KBD_01: Tool = {
  id: "HERO_COMP_KBD_01",
  name: "Define KBD Component Variant",
  description: "Defines and stores a new kbd component variant based on provided specifications.",
