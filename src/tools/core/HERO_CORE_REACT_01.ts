...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this react core module variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this react core module variant."),
  ...
  }).partial().describe("Additional metadata for the react core module variant."),
});
...
export const HERO_CORE_REACT_01: Tool = {
  id: "HERO_CORE_REACT_01",
  name: "Define React Core Module Variant",
  description: "Defines and stores a new react core module variant based on provided specifications.",
  ...
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      ...
      targetComponent: "react", // Using targetComponent for now, might need a new field for core modules
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
