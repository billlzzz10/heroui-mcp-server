...
export const inputSchema = z.object({
  name: z.string().optional().describe("Optional name for this theme core module variant."),
  props: z.record(z.string(), z.any()).describe("A key-value pair of props specific to this theme core module variant."),
  ...
  }).partial().describe("Additional metadata for the theme core module variant."),
});
...
export const HERO_CORE_THEME_01: Tool = {
  id: "HERO_CORE_THEME_01",
  name: "Define Theme Core Module Variant",
  description: "Defines and stores a new theme core module variant based on provided specifications.",
  ...
  execute: async (input: z.infer<typeof inputSchema>) => {
    const newComponentVariant: Omit<ComponentVariantObject, 'hash'> = {
      ...
      targetComponent: "theme", // Using targetComponent for now, might need a new field for core modules
      name: input.name,
      props: input.props,
      styleObjectHashes: {},
